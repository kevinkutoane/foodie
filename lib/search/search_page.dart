...
class FoodSearch extends SearchDelegate<String> {
  ...
  final List<String> recentSearches = ['Burger', 'Steak'];
  ...
  Widget buildResults(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: Image.asset('assets/menu/${foodItem['image']}', width: 150, height: 150, fit: BoxFit.cover),
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => DetailPage(
                  ...
                  foodRating: foodItem['rating'], foodImage: foodItem['image'],
                ),
              ),
            );
          },
